...
public class DataHolder {
    ...
    public void init(){
        ...
        teachers.add(new Teacher("Risto","Ristevski", LocalDate.now()));
        teachers.add(new Teacher("Saso","Saso",LocalDate.now()));
        teachers.add(new Teacher("Dimitar","Gjorgievski",LocalDate.now()));
        teachers.add(new Teacher("Ana","Ana",LocalDate.now()));
        teachers.add(new Teacher("Kosta","Kostic",LocalDate.now()));
    }
}
